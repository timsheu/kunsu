...
skills/                → skill 原始碼
  handoff/             → 通用交接原語（v0.3.0，2026-07-06 自部署目錄併入，見 ADR 003）
...
| [docs/adr/](docs/adr/) | ADR（001–004 於 2026-07-06、005 於 2026-07-07 審定為 accepted；006 申請信箱 proposed；007 角色代碼／說明分離於 2026-07-08 accepted；008 上報信箱於 2026-07-08 proposed） |
...
### 尚未實作／後續評估
- 上報信箱（`docs/reports/`，子專案主動上報管道）——[ADR 008 candidate](docs/adr/2026-07-08-adr-candidate-008-report-inbox-triple-mailbox.md) 已起草（例外授權擴為三信箱、report／handoff／application 以「有無對應交接」結構判準分界、觸發詞分配含「稟報軍師」、雙向重導、`/kunsu-report` 投遞 skill），待審定後另立實作計畫；現存孤兒回覆依其 Decision 8 於落地後遷入。
