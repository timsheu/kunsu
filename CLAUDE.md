...
skills/                → skill 原始碼
  handoff/             → 通用交接原語（v0.6.0，2026-07-06 自部署目錄併入，見 ADR 003）
    SKILL.md           → add／reply／list／done 子指令（reply 含 kunsu 語境分支與 verify 驗收方式選填欄位；done 含收尾口語觸發與發起方守門；add／done／本地 reply 尾端確認 commit）
